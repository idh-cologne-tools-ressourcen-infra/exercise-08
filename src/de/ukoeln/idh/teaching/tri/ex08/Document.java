...
public class Document {
	...
	public static void main(String[] args) {
        ...
        document.getTokens().get(2).setGov(document.getTokens().get(3),"aux");
        document.getTokens().get(3).setGov(null, null);
        document.getTokens().get(4).setGov(document.getTokens().get(3),"prep");
        document.getTokens().get(5).setGov(document.getTokens().get(6),"compund");
        document.getTokens().get(6).setGov(document.getTokens().get(3),"obj");
        document.getTokens().get(7).setGov(document.getTokens().get(6),"punct");
        document.getTokens().get(8).setGov(document.getTokens().get(9),"modifier");
        document.getTokens().get(9).setGov(document.getTokens().get(6),"det");
        document.getTokens().get(10).setGov(document.getTokens().get(12),"det");
        document.getTokens().get(11).setGov(document.getTokens().get(12),"modifier");
        ...
        document.getEntities.add(new NamedEntitiy(document.getTokens().get(6), "person", 0,9f));
